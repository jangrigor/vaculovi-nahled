...
export default function Palirna() {
  ...
  return (
    ...
    >
      ...
      {/* Na mobilu o kousek výš — popisek pod nadpisem jinak končí přesně na
          trubce kotle. Níž než 11 % to nejde: hlavička je vysoká 69 px a při
          scrollu ztmavne, takže by nadpis zakryla. */}
      <div className="pointer-events-none absolute inset-x-0 top-[11%] z-50 flex flex-col items-center px-5 text-center sm:top-[12%]">
        <h2 className="leading-[0.95] text-wheat">
          ...
          <span className="mt-2 block font-sans text-xs uppercase tracking-[0.3em] text-wheat/50 sm:mt-4 sm:text-sm">
            Pěstitelská palírna
          </span>
        </h2>
      </div>
      ...
      {/* Na mobilu níž a stlačenější, ať blok slezl z kamen na podlahu. */}
      <div className="absolute bottom-4 left-5 right-5 z-50 flex max-w-full flex-col items-start gap-3 sm:bottom-24 sm:left-auto sm:right-10 sm:max-w-[280px] sm:gap-5 md:right-14">
        <div>
